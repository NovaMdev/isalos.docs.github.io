...
Below are some use cases of Isalos Analytics Platform in ANOVA applications. Each case study is accompanied by:
...
#### Manufacturing Process Optimization ([`One-Way ANOVA`](https://www.docs.isalos.novamechanics.com/anova_ancova.html#one-way-anova))
{: .no_toc }
* [Isalos workflow](files\ANOVA\Manufacturing\manufacturing_v212.iap)
* [Report](files\ANOVA\Manufacturing\manufacturing_v212.pdf)
